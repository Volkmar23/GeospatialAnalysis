...
## Outdated.
### def open_dataset_with_retries(link, max_retries=3, delay = 60):
###     attempt = 0
###     while attempt < max_retries:
###         try:
###             nasa_cmip6 = xr.open_dataset(link)
###             return nasa_cmip6  # If open is successful, return the dataset
###         except OSError as e:
###             attempt += 1
###             print(f"Attempt {attempt} failed: {e.strerror}")
