...
def rain_test(url_nsa: str, assets: pd.DataFrame, path_storage: str) -> None:
    ...
    FUTURE_PERIODS = [(2020, 2039), (2040, 2059), (2060, 2079), (2080, 2100)]
    FUTURE_PERIODS_LABELS = ['2020-2040', '2040-2060', '2060-2080', '2080-2100']
    ...
    for (escenario, modelo, dtype), df_type_escenario in dtype_ssp_grouper:
        ...
        escenario_format_name = SCENARIO_MAPPING[escenario]
        folder_escenario = scenario_results.setdefault(escenario_format_name, {})
        ...
        if escenario == 'historical':
            ...
            for variable, list_numba in stat_temp.items():
                ...
                mean_var = np.mean(a=stack_array, axis=0)
    ...
    for escenario, stat_dict in scenario_results.items():
        tortugaso = {}
